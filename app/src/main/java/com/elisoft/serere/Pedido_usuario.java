...
public class Pedido_usuario extends AppCompatActivity implements OnMapReadyCallback , View.OnClickListener,
...
// localizacion automatica
    ...
    private void flotante_pedir(boolean b) {
        ...
        if(b==false) {
            ...
            Intent intent1 = new Intent(Pedido_usuario.this, Servicio_chat.class);
    ...
    private void llamar_a_taxicorp() {
        mensaje("formulario contactar empresa");
        /*
    ...
    private void llamar_radio_movil() {
        ...
        llamada.setData(Uri.parse("tel:" +getString(R.string.telefono)));
...
*/
            ...
            jsa_carrito=cargar_carrito_en_array(0);
    ...
    private void servicio_pedir_taxi(String id,
        ...
        try {
            ...
            jsonParam.put("token", token);
            jsonParam.put("carrito", jsa_carrito);
            jsonParam.put("id_empresa", carrito.getInt("id_empresa",0));
            jsonParam.put("monto_envio", monto_envio);
            String url=getString(R.string.servidor) + "frmDelivery.php?opcion=pedir_delivery";
            if (queue == null) {
                queue = Volley.newRequestQueue(this);
                Log.e("volley","Setting a new request queue");
            }
...
//500
    ...
    public void eliminar_servicio_cargar_ubicacion(){
        Intent stopIntent = new Intent(Pedido_usuario.this, Servicio_cargar_punto_google.class);
        stopIntent.setAction(Constants.ACTION.STOP_ACTION);
        stopService(stopIntent);
    }


    public JSONArray cargar_carrito_en_array(int id_ped)
    {
        ...
        SQLiteDatabase bd = admin.getWritableDatabase();
        Cursor fila = bd.rawQuery("select id_producto,id_pedido,cantidad,nombre,url,monto_unidad,monto_total from carrito where id_pedido="+id_ped  , null);
        ...
        if (fila.moveToFirst()) {  //si ha devuelto 1 fila, vamos al primero (que es el unico)
            ...
            do {
                ...
                double monto_unidad  = Double.parseDouble(fila.getString(5));
                double monto_total  = Double.parseDouble(fila.getString(6));
                try {
